...
## **Решение**
1. Вы находитесь в созданном репозитории `FinalWork_1quarter`.
2. Блок-схема алгоритма:
> Для удобства проверки разных массивов в программе использован оператор `switch`, функции ввода/вывода в консоль.   
...
5. Скриншот части коммитов.

> ![Screenshot of commits](gitlog.png)